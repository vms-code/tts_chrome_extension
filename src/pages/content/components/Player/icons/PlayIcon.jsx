export default function PlayIcon({ width, height, fill="#000000", className="" }) {
    return (
        <svg className={className} xmlns="http://www.w3.org/2000/svg" fill={fill} width={width} height={height} viewBox="0 0 32 32" version="1.1">
            <title>play</title>
